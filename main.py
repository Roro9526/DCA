...
def ensure_logos(specs: List[Tuple[str, str, Optional[str]]]) -> None:
    """
    Vérifie qu'un logo local existe pour chaque label (recherche uniquement,
    aucun téléchargement réel n'est effectué). Désactivable via AUTO_DOWNLOAD_LOGOS=false.
